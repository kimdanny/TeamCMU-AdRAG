...
def process_jsonl_file_with_batching(input_file, output_file, batch_size=300):
    ...
    for i in tqdm(
        range(0, len(all_passages), batch_size),
        total=total_batches,
...
def build_filtered_datasets(
    jsonl_file, items_file, output_min_file, output_min_max_file
):
    items_dict = {}
    ...
    print(
        f"Created dataset with best and worst answers: {len(min_max_dataset)} entries"
    )
...
PATH_IN = "/your_path/generated_ads_Qwen2.5-7B-Instruct_temp_1.0.jsonl"
PATH_OUT = (
    "/your_path/generated_ads_Qwen2.5-7B-Instruct_temp_1.0_with_ad_likelihood.jsonl"
)
min_likelihoods, max_likelihoods = process_jsonl_file_with_batching(PATH_IN, PATH_OUT)

PATH_KDE_OUT = "/your_path/kde.pdf"
plot_kde(min_likelihoods, max_likelihoods, PATH_KDE_OUT)

PATH_ITEMS = "/your_path/Qwen2.5-7B-Instruct-10-passage-RAG_with_item.jsonl"
PATH_OUT_STF = "/your_path/generated_ads_Qwen2.5-7B-Instruct_temp_1.0_stf.jsonl"
PATH_OUT_DPO = "/your_path/generated_ads_Qwen2.5-7B-Instruct_temp_1.0_dpo.jsonl"
