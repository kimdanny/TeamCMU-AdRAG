...
PATH_TO_DATA = "preprocess_data/generated_ads_Qwen2.5-7B-Instruct_temp_1.0_stf.jsonl"
...
if __name__ == "__main__":
    ...
    args = SFTConfig(
        ...
        report_to="wandb",
        run_name="sft_test",
        deepspeed="ad_rewriter/train_sft_rewriter/deepspeed/ds.json",
    )
