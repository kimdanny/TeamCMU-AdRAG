...
jsonl_file = "/your_path/data/subtask-1/touche-task4-2025-segments.jsonl"
...
PATH_TO_ANSWERS = f"/your_path/generator/output/marcov2.train.set2/Qwen2.5-0.5B-bidirectional-attn-mntp-marco-passage-hard-negatives-matrioshka-reduction-2/Qwen2.5-7B-Instruct-10-passage-RAG_{task_id}.jsonl"
...
output_file = os.path.join(
    "/your_path/rewriter/output/marcov2.train.set2/items",
    f"Qwen2.5-7B-Instruct-10-passage-RAG_{task_id}_item.jsonl",
)
with open(output_file, "w", encoding="utf-8") as f:
    for output, entry in zip(outputs, data_entries):
        ...
        f.write(
            json.dumps({"query_id": query_id, "response": response, "item": item})
            + "\n"
        )
