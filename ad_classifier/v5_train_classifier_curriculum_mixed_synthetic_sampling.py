"""
Classifier Version 0.5
HF URL: https://huggingface.co/teknology/ad-classifier-v0.5
For curriculumn learning, we rank the data by the classification confidence (by logit value)
We also upsample Webis-Ads and StructuredSythetic data and downsample NaiveSynthetic data
"""
